//
//  GraphicsFavoritesViewController.m
//  Calculator
//
...
@interface GraphicsFavoritesViewController ()
...
{
    static NSString *CellIdentifier = @"GraphicFavoritesCell";
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    
    cell.textLabel.text = [self.favorites.allKeys objectAtIndex:indexPath.row];
...
{
    return [self.selection respondsToSelector:@selector(controller:didDelete:)];
}
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        NSString *programName = [self.favorites.allKeys objectAtIndex:indexPath.row];
        [self.selection controller:self didDelete:programName];
    }   
